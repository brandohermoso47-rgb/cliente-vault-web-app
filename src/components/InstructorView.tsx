              ...
              <div>
                ...
                <div className="space-y-1">
                  {[
                    ...
                    { id: 'documents', label: language === 'es' ? 'Documentos & Guías PDF' : 'PDF Guides & Documents', icon: FileText, badge: `${instructorDocuments.length}` },
              ...
              <div>
                ...
                <div className="space-y-1">
                  {[
                    ...
                    { id: 'soundcloud', label: language === 'es' ? 'Listas de Reproducción & Nube' : 'Instructor Playlists & Cloud', icon: Disc, badge: 'NUBE ☁️' }
                  ].map(item => {
                    const Icon = item.icon;
                    const active = activeSubTab === item.id;
                    return (
